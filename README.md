...
3. **Apply the database migrations** — in the Supabase dashboard open *SQL Editor* and run the files in `supabase/migrations/` **in order (0001 → 0028)**, or use the Supabase CLI:
...
docs/costing.md             Costing module — formulas, schema, progress (living)
docs/costing-module-plan.md Costing module — agreed scope and phasing
